...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Collections_Generic_Dictionary_2_String_Int32_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (method != null) app.RegisterCLRMethodRedirection(method, get_Comparer_0); 
            args = new Type[]{};
            method = type.GetMethod("get_Count", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, get_Count_1); 
            args = new Type[]{};
            method = type.GetMethod("get_Keys", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, get_Keys_2); 
            args = new Type[]{};
            method = type.GetMethod("get_Values", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, get_Values_3); 
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("get_Item", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, get_Item_4); 
            args = new Type[]{typeof(System.String), typeof(System.Int32)};
            method = type.GetMethod("set_Item", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, set_Item_5); 
            args = new Type[]{typeof(System.String), typeof(System.Int32)};
            method = type.GetMethod("Add", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, Add_6); 
            args = new Type[]{};
            method = type.GetMethod("Clear", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, Clear_7); 
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("ContainsKey", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, ContainsKey_8); 
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("ContainsValue", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, ContainsValue_9); 
            args = new Type[]{};
            method = type.GetMethod("GetEnumerator", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, GetEnumerator_10); 
            ...
            if (method != null) app.RegisterCLRMethodRedirection(method, GetObjectData_11); 
            args = new Type[]{typeof(System.Object)};
            method = type.GetMethod("OnDeserialization", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, OnDeserialization_12); 
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("Remove", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, Remove_13); 
            ...
            if (method != null) app.RegisterCLRMethodRedirection(method, TryGetValue_14); 


            app.RegisterCLRCreateDefaultInstance(type, () => new System.Collections.Generic.Dictionary<System.String, System.Int32>());
            app.RegisterCLRCreateArrayInstance(type, s => new System.Collections.Generic.Dictionary<System.String, System.Int32>[s]);
        ...
        static StackObject* get_Comparer_0(ILIntepreter __intp, StackObject* __esp, List<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method = (System.Collections.Generic.Dictionary<System.String, System.Int32>)typeof(System.Collections.Generic.Dictionary<System.String, System.Int32>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Ctor_4(ILIntepreter __intp, StackObject* __esp, List<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.IDictionary<System.String, System.Int32> dictionary = (System.Collections.Generic.IDictionary<System.String, System.Int32>)typeof(System.Collections.Generic.IDictionary<System.String, System.Int32>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
