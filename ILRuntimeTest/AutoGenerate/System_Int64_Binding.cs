...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Int64_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (method != null) app.RegisterCLRMethodRedirection(method, CompareTo_0); 
            args = new Type[]{typeof(System.Int64)};
            method = type.GetMethod("CompareTo", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, CompareTo_1); 
            args = new Type[]{typeof(System.Object)};
            ...
            if (method != null) app.RegisterCLRMethodRedirection(method, ToString_5); 
            args = new Type[]{typeof(System.IFormatProvider)};
            method = type.GetMethod("ToString", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, ToString_6); 
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("ToString", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, ToString_7); 
            args = new Type[]{typeof(System.String), typeof(System.IFormatProvider)};
            method = type.GetMethod("ToString", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, ToString_8); 
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("Parse", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, Parse_9); 
            args = new Type[]{typeof(System.String), typeof(System.Globalization.NumberStyles)};
            method = type.GetMethod("Parse", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, Parse_10); 
            args = new Type[]{typeof(System.String), typeof(System.IFormatProvider)};
            method = type.GetMethod("Parse", flag, null, args, null);
            ...
            if (method != null) app.RegisterCLRMethodRedirection(method, TryParse_13); 
            ...
            method = type.GetMethod("TryParse", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, TryParse_14); 
            args = new Type[]{};
            method = type.GetMethod("GetTypeCode", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, GetTypeCode_15); 

            field = type.GetField("MaxValue", flag);
            if (field != null) app.RegisterCLRFieldGetter(field, get_MaxValue_0); 
            field = type.GetField("MinValue", flag);
            if (field != null) app.RegisterCLRFieldGetter(field, get_MinValue_1); 
