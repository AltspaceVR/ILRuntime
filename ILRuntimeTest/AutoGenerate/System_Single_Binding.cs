...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Single_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (method != null) app.RegisterCLRMethodRedirection(method, IsInfinity_0); 
            args = new Type[]{typeof(System.Single)};
            method = type.GetMethod("IsPositiveInfinity", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, IsPositiveInfinity_1); 
            args = new Type[]{typeof(System.Single)};
            method = type.GetMethod("IsNegativeInfinity", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, IsNegativeInfinity_2); 
            args = new Type[]{typeof(System.Single)};
            method = type.GetMethod("IsNaN", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, IsNaN_3); 
            args = new Type[]{typeof(System.Object)};
            method = type.GetMethod("CompareTo", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, CompareTo_4); 
            args = new Type[]{typeof(System.Single)};
            method = type.GetMethod("CompareTo", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, CompareTo_5); 
            args = new Type[]{typeof(System.Object)};
            method = type.GetMethod("Equals", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, Equals_6); 
            args = new Type[]{typeof(System.Single)};
            method = type.GetMethod("Equals", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, Equals_7); 
            args = new Type[]{};
            method = type.GetMethod("GetHashCode", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, GetHashCode_8); 
            args = new Type[]{typeof(System.IFormatProvider)};
            method = type.GetMethod("ToString", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, ToString_9); 
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("ToString", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, ToString_10); 
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("Parse", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, Parse_11); 
            args = new Type[]{typeof(System.String), typeof(System.Globalization.NumberStyles)};
            method = type.GetMethod("Parse", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, Parse_12); 
            args = new Type[]{typeof(System.String), typeof(System.IFormatProvider)};
            method = type.GetMethod("Parse", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, Parse_13); 
            args = new Type[]{typeof(System.String), typeof(System.Globalization.NumberStyles), typeof(System.IFormatProvider)};
            method = type.GetMethod("Parse", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, Parse_14); 
            args = new Type[]{typeof(System.String), typeof(System.Single).MakeByRefType()};
            method = type.GetMethod("TryParse", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, TryParse_15); 
            ...
            method = type.GetMethod("TryParse", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, TryParse_16); 
            args = new Type[]{};
            method = type.GetMethod("GetTypeCode", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, GetTypeCode_17); 
            args = new Type[]{};
            method = type.GetMethod("ToString", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, ToString_18); 
            args = new Type[]{typeof(System.String), typeof(System.IFormatProvider)};
            method = type.GetMethod("ToString", flag, null, args, null);
            if (method != null) app.RegisterCLRMethodRedirection(method, ToString_19); 

            field = type.GetField("MinValue", flag);
            if (field != null) app.RegisterCLRFieldGetter(field, get_MinValue_0); 
            field = type.GetField("Epsilon", flag);
            if (field != null) app.RegisterCLRFieldGetter(field, get_Epsilon_1); 
            field = type.GetField("MaxValue", flag);
            if (field != null) app.RegisterCLRFieldGetter(field, get_MaxValue_2); 
            field = type.GetField("PositiveInfinity", flag);
            if (field != null) app.RegisterCLRFieldGetter(field, get_PositiveInfinity_3); 
            field = type.GetField("NegativeInfinity", flag);
            if (field != null) app.RegisterCLRFieldGetter(field, get_NegativeInfinity_4); 
            field = type.GetField("NaN", flag);
            if (field != null) app.RegisterCLRFieldGetter(field, get_NaN_5); 
